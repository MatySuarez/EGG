///Matriz cuadrada de mxm y se busca que las dos diagonales principales que todas las bases sean iguales.
///Para que la muestra sea válida el orden de la matriz( el orden de M) debe ser
///3,4 o 37 por descgracia no es posiuble saber el orden de la matriz y el mismo debe ser inferido de la muestra ingresada. 
///Hacer un programa que permita ingresar una muestra completa, detectar si es válida,
